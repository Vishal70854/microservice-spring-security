...
public class RestaurantOrderDAO {
    ...
    public OrderResponseDTO getOrders(String orderId) {
        return generateRandomOrders().get(orderId); // get the Order details in the form of OrderResponseDTO
    }

    // generate Random orders(currently we have hardcoded value)
    // as this is example microservice project using spring security with jwt
